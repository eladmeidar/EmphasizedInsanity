...
* "IntoVPS":http://www.intovps.com/ - another VPS service provider, europe/USA options...worths checking out.
...
* "brit":http://codaset.com/codaset/grit - Grit gives you object oriented read/write access to Git repositories via Ruby.
