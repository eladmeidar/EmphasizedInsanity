...
As *Fredric* mentioned in the first comment for this post, Authlogic gives us an easier way to access the logged in users by giving us a few _scopes_ we can use such as *logged_in* and *logged_on* (_Authlogic::ActsAsAuthentic::LoggedInStatus_)
...
which is way easier, thanks *Fredric*.
